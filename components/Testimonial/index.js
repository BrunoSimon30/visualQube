...
export default function Testimonial({ rtc }) {
  ...
  return (
    <>
      <section
        ref={testRef}
        className="testi-sec bg-[#030728] md:h-screen py-24 md:py-0 flex items-center px-8 relative"
      >
          ...
          <div className="up_h md:grid md:grid-cols-3 gap-28 items-center">
            ...
            <div className="col-span-2 space-y-8">
              <p className="text-[30px] leading-[40px] md:text-[3.333vw] md:leading-[3.333vw] text-white">
                VisualQube’s team exceeded our expectations! They delivered our
                project with incredible speed and precision, ensuring every
                detail was perfect. Highly recommended!
              </p>
